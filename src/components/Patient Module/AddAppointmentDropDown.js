...
class AddAppointmentDropDown extends React.Component {
  ...
  componentDidMount() {
    Axios.get("http://localhost:8080/health/appointment/retrievealltest").then(
      (j) => {
  ...
  onSub(e) {
    e.preventDefault();
    var url =
      "http://localhost:8080/health/appointment/addAppointmentbydropdown/" +
                ...
                <form onSubmit={this.onSub}>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      className="form-control"
                    >
                      {this.state.diagnosticTestId.map((n) => (
