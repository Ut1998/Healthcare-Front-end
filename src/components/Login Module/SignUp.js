  ...
  addUser = async (e) => {
    ...
    try {
      resp = await axios.post(
        "http://localhost:8080/health/patient/addpatient",
        user
      );
                ...
                <form onSubmit={this.addUser}>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      title="First letter should be capital and should not contain spaces"
                  ...
                  <div className="form-group">
                    ...
                    <input
                      type="text"
                      placeholder="9616787297"
                      name="phoneNo"
                      className="form-control"
                      pattern="[6-9][0-9]{9}"
                      autoComplete="off"
                      title="Should start with 6-9 and must be 10 digits."
